...
export const RESELLER_COPY = {
  de: {
    ...
    dashboard: {
      ...
      optional: "(optional)",
      vatPlaceholder: "z. B. DE123456789",
      billingStreet: "Rechnungsadresse – Straße und Hausnummer",
      postalCode: "PLZ",
      city: "Ort",
      countryBilling: "Land (Rechnungsadresse)",
      shippingStreet: "Lieferadresse – Straße und Hausnummer",
      countryShipping: "Land (Lieferadresse)",
      note: "Anmerkung",
  ...
  hu: {
    ...
    dashboard: {
      ...
      optional: "(opcionális)",
      vatPlaceholder: "pl. 12345678-1-42",
      billingStreet: "Számlázási cím – utca és házszám",
      postalCode: "Irányítószám",
      city: "Város",
      countryBilling: "Ország (számlázási cím)",
      shippingStreet: "Szállítási cím – utca és házszám",
      countryShipping: "Ország (szállítási cím)",
      note: "Megjegyzés",
  ...
  en: {
    ...
    dashboard: {
      ...
      optional: "(optional)",
      vatPlaceholder: "e.g. DE123456789",
      billingStreet: "Billing address – street and house number",
      postalCode: "Postal code",
      city: "City",
      countryBilling: "Country (billing address)",
      shippingStreet: "Shipping address – street and house number",
      countryShipping: "Country (shipping address)",
      note: "Note",
