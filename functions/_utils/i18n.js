...
export const RESELLER_COPY = {
  de: {
    ...
    dashboard: {
      ...
      onboardingStep3: "Sie genießen die Seite, Sie erzielen Ihren Gewinn daran",
  ...
  hu: {
    ...
    dashboard: {
      ...
      onboardingStep3: "Ők élvezik az oldalt, te pedig megkeresed rajta a hasznod",
  ...
  en: {
    ...
    dashboard: {
      ...
      onboardingStep3: "They enjoy the page, you earn your margin on it",
