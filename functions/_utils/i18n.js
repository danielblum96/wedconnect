...
export const RESELLER_COPY = {
  de: {
    ...
    dashboard: {
      ...
      buttonSuggestions: ["Hochzeitsfotos", "Hochzeitsvideos", "Selfie-Box-Fotos", "RSVP", "Geschenkeliste"],
      useDefaultTextLabel: "Standardtext übernehmen:",
  ...
  hu: {
    ...
    dashboard: {
      ...
      buttonSuggestions: ["Esküvői képek", "Esküvői videók", "Selfie box fotók", "RSVP", "Ajándéklista"],
      useDefaultTextLabel: "Alapszöveg átvétele:",
  ...
  en: {
    ...
    dashboard: {
      ...
      buttonSuggestions: ["Wedding photos", "Wedding videos", "Selfie box photos", "RSVP", "Gift registry"],
      useDefaultTextLabel: "Use the default text:",
