...
export const RESELLER_COPY = {
  de: {
    ...
    dashboard: {
      ...
      onboardingIntro: "Nur noch drei Schritte bis zu Ihrer ersten Provision:",
      ...
      onboardingStep3: "Sie genießen die Seite, Sie erhalten Ihre Provision",
  ...
  hu: {
    ...
    dashboard: {
      ...
      onboardingIntro: "Már csak három lépés választ el az első jutalékodtól:",
      ...
      onboardingStep3: "Ők élvezik az oldalt, te pedig megkapod a jutalékod",
  ...
  en: {
    ...
    dashboard: {
      ...
      onboardingIntro: "Just three steps to your first commission:",
      onboardingStep1: "Create a wedding page for a couple – under 2 minutes",
      onboardingStep2: "Share the link or QR code with them",
      onboardingStep3: "They enjoy the page, you earn your commission",
